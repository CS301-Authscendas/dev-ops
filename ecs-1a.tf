...
resource "aws_lb_target_group_attachment" "external_alb_target_group_attachment_webserver_1a" {
  target_group_arn = aws_lb_target_group.external_alb_target_group.arn
  target_id        = aws_ecs_service.aws_ecs_service_webserver_1a.id
  port             = var.microservices["webserver"].hostPort
}

resource "aws_lb_target_group_attachment" "internal_alb_target_group_attachment_authentication_1a" {
  target_group_arn = aws_lb_target_group.internal_alb_target_group.arn
  target_id        = aws_ecs_service.aws_ecs_service_authentication_1a.id
  port             = var.microservices["authentication"].hostPort
}

resource "aws_lb_target_group_attachment" "internal_alb_target_group_attachment_users_1a" {
  target_group_arn = aws_lb_target_group.internal_alb_target_group.arn
  target_id        = aws_ecs_service.aws_ecs_service_users_1a.id
